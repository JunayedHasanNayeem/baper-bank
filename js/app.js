...
document.getElementById('withdraw-button').addEventListener('click', function(){
 ...
 /* //Error Message
        const inputBox = inputElement.parentNode;
        const errorMessage = document.createElement("p");
        inputBox.prepend(errorMessage);
        errorMessage.className = "py-3 px-4 my-4 rounded bg-red-50";
        ...
        //Clear the number from the input field
...
document.getElementById('deposit-button').addEventListener('click', function(){
    ...
    const newDepositTotal = parseFloat( newDepositAmount) + parseFloat(previousDepositAmount);
    depositTotal.innerText = newDepositTotal;
    //Total Balance
    let totalBalance = document.getElementById('balance-total');
    const previousTotalBalance = totalBalance.innerText;
    totalBalance.innerText = parseFloat(previousTotalBalance) + parseFloat(newDepositAmount);
    //Clear the number from the input field
    depositInput.value = "";
...
document.getElementById('withdraw-button').addEventListener('click', function(){
    ...
    let totalBalance = document.getElementById('balance-total');
    const previousTotalBalance = totalBalance.innerText;
    totalBalance.innerText = parseFloat(previousTotalBalance) - parseFloat(newWithdrawAmount);
